    ...
    <main className="flex-grow flex items-center justify-center pt-24 pb-12 px-6">
      <div className="max-w-5xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          {/* Sponsor Card */}
          <Link href="/register/sponsor" className="group relative bg-inverse-surface p-8 md:p-12 rounded-xl shadow-sm hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-secondary cursor-pointer flex flex-col justify-between overflow-hidden">
            ...
            <div>
              ...
              <h2 className="text-3xl font-headline font-bold text-surface mb-4">I am a Sponsor</h2>
