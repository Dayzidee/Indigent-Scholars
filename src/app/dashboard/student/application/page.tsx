          ...
          <section>
            <Card className="bg-zinc-900 rounded-[40px] border-none shadow-2xl shadow-blue-900/5 p-10 lg:p-14">
               <div className="flex items-center gap-4 mb-10">
                  ...
                  <div>
                    <h3 className="text-2xl font-headline font-black text-zinc-100">Application Narrative</h3>
               ...
               <div className="space-y-8">
                  ...
                  <div className="relative group">
                    <label className="absolute left-6 top-4 z-10 text-[10px] font-black text-[#0052CC] uppercase tracking-widest bg-zinc-900 px-2 rounded-sm group-focus-within:border-[#0052CC]">Your Scholarship Story</label>
                    <textarea 
                      value={formData.story}
                      onChange={(e) => setFormData({ ...formData, story: e.target.value })}
                      className="w-full min-h-[250px] bg-zinc-800/30 border-2 border-zinc-700 rounded-[32px] p-8 pt-10 text-zinc-200 font-medium focus:outline-none focus:border-[#0052CC] focus:ring-4 focus:ring-blue-600/5 transition-all outline-none resize-none"
                    />
                  </div>
               ...
               <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                  <div className="flex-1">
                     <div className="flex items-center gap-3 mb-4">
                        <span className="px-3 py-1 rounded-full bg-white/10 text-white text-[8px] font-black uppercase tracking-widest border border-zinc-800/10">Action Required</span>
            ...
            <Card className="bg-zinc-900 rounded-[40px] border-none shadow-2xl shadow-zinc-200/50 overflow-hidden">
               ...
               <div className="bg-zinc-800 border-b border-zinc-800 px-8 py-5 flex items-center justify-between">
                  <div className="flex gap-4">
                     <div className="flex items-center gap-2 text-zinc-400 hover:text-zinc-400 cursor-pointer transition-colors">
               ...
               <div className="divide-y divide-zinc-100">
                  {MOCK_MESSAGES.map((msg, i) => (
                    <motion.div 
                      ...
                      className="p-8 lg:p-12 hover:bg-zinc-800/50 transition-all group"
                    >
                       <div className="flex flex-col lg:flex-row gap-8">
                          ...
                          <div className="flex-1 min-w-0">
                             <div className="flex flex-col sm:flex-row justify-between items-start mb-4 gap-2">
                                <div>
                                   <h4 className="text-sm font-black text-zinc-100 group-hover:text-[#0052CC] transition-colors">{msg.sender}</h4>
                                   <p className="text-xl font-headline font-black text-zinc-200 tracking-tight mt-1">{msg.subject}</p>
                                </div>
                                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest bg-zinc-800 px-3 py-1 rounded-full">{msg.date}</p>
                             </div>
                             <div className="bg-zinc-800/50 border border-zinc-800 rounded-[32px] p-6 lg:p-8">
               ...
               <div className="p-8 bg-zinc-800/50 border-t border-zinc-800">
                  <div className="flex items-center gap-4 bg-zinc-900 border-2 border-zinc-800 rounded-full px-8 py-3 focus-within:border-[#0052CC] transition-all">
                     <input 
