  ...
  if (submitted) {
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50/50">
        ...
        >
          <Card className="p-12 rounded-[40px] border-none shadow-2xl bg-white text-center">
             ...
             <h2 className="text-3xl font-headline font-black text-zinc-900 mb-4 tracking-tight">Application Submitted!</h2>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <span className="px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 text-[8px] font-black uppercase tracking-widest border border-emerald-100">Verification Active</span>
              <h1 className="text-4xl font-headline font-black text-zinc-900 tracking-tight">Final Funding Review</h1>
            </div>
            <p className="text-zinc-500 font-medium">Please review all your provided information before final submission.</p>
          </div>
          <div className="px-6 py-4 rounded-[28px] bg-white border-2 border-emerald-100 shadow-sm flex items-center gap-4">
             ...
             <div>
                ...
                <p className="text-sm font-headline font-black text-zinc-900">Verification Success</p>
             </div>
          </div>
        </div>
        ...
        <div className="space-y-12">
          ...
          <section className="space-y-6">
            <h3 className="text-xl font-headline font-black text-zinc-900 ml-2">Application Overview</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
               {[
                 { label: "Application ID", value: "IS-2024-8842", icon: "fingerprint", color: "text-blue-600 bg-blue-50" },
                 ...
                 <Card key={i} className="p-6 rounded-[32px] border-none bg-white shadow-xl shadow-zinc-200/40 flex items-center gap-5">
                   ...
                   <div>
                     ...
                     <p className="text-sm font-headline font-black text-zinc-900 tracking-tight">{item.value}</p>
                   </div>
                 </Card>
               ))}
            </div>
          ...
          <section className="space-y-6">
            <h3 className="text-xl font-headline font-black text-zinc-900 ml-2">Registration Identity</h3>
            <CategorizedProfile />
          </section>

          {/* Module 3: Application Story & Narrative */}
          <section className="space-y-6">
            <h3 className="text-xl font-headline font-black text-zinc-900 ml-2">Scholarship Narrative</h3>
            <Card className="p-10 lg:p-14 rounded-[40px] border-none bg-white shadow-2xl shadow-blue-900/5 relative overflow-hidden">
                 ...
                 <div className="flex items-center justify-between mb-10">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-2xl font-headline font-black text-zinc-900 tracking-tight">₦150,000.00</p>
                       </div>
                    </div>
                    <Button variant="ghost" size="sm" iconRight="edit" className="text-[#0052CC]">Edit Story</Button>
                 </div>
                 <div className="bg-zinc-50/50 rounded-[32px] p-8 lg:p-10 border border-zinc-100">
          ...
          {/* Submission Footer */}
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-10 border-t border-zinc-200">
             <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-blue-50 text-[#0052CC] flex items-center justify-center">
