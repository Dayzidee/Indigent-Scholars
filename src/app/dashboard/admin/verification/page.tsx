      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div>
            ...
            <h1 className="text-4xl lg:text-5xl font-black font-headline tracking-tighter text-zinc-900 leading-none">Verification Center</h1>
          ...
          <div className="flex gap-3 bg-white p-2 rounded-2xl shadow-sm border border-zinc-100">
             <div className="px-6 py-3 text-center">
                ...
                <p className="text-2xl font-black text-zinc-900 leading-none">24</p>
             </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
           ...
           <div className="lg:col-span-5 space-y-4">
              <div className="flex items-center justify-between px-2 mb-6">
                <h3 className="font-headline font-black text-lg text-zinc-900">Review Queue</h3>
                  ...
                  >
                    <Card 
                      ...
                      className={cn(
                        ...
                        selectedStudent?.id === student.id ? "bg-[#0052CC] text-white ring-4 ring-blue-100" : "bg-white text-zinc-900"
                      )}
                    >
                      <div className="flex items-center gap-5 relative z-10">
                        <div className={cn(
                          ...
                          student.color,
                          selectedStudent?.id === student.id && "bg-white/20 text-white"
                        )}>
                          {student.initials}
                        </div>
                        ...
                        <div className="ml-auto flex flex-col items-end gap-2">
                          <span className={cn(
                            ...
                            selectedStudent?.id === student.id ? "bg-white/20 text-white" : "bg-blue-50 text-[#0052CC]"
                          )}>
           ...
           <div className="lg:col-span-7">
              {selectedStudent ? (
                <motion.div
                  ...
                  className="space-y-8"
                >
                  <Card className="bg-white rounded-[40px] border-none shadow-2xl p-10 lg:p-14 relative overflow-hidden group">
                     {/* Identity Header */}
                     <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-12">
                        <div className="space-y-2">
                           <p className="text-[#0052CC] text-[10px] font-black uppercase tracking-[0.2em]">Auditing Student Identity</p>
                           <h2 className="text-4xl font-headline font-black text-zinc-900 tracking-tighter leading-none">{selectedStudent.name}</h2>
                           <p className="text-zinc-400 text-sm font-medium">{selectedStudent.id} • {selectedStudent.university}</p>
                        </div>
                        <div className="flex gap-2">
                           <button className="w-12 h-12 rounded-2xl bg-zinc-50 text-zinc-400 flex items-center justify-center hover:bg-zinc-100 transition-colors">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                        {selectedStudent.docs.map((doc, idx) => (
                           <div key={idx} className="space-y-4">
                              ...
                              <div className="aspect-[4/3] bg-zinc-100 rounded-3xl overflow-hidden border border-zinc-200 group/doc relative flex items-center justify-center">
                     ...
                     <div className="pt-12 border-t border-zinc-100 flex flex-col sm:flex-row items-center justify-between gap-8">
                        <div className="flex items-center gap-6">
                           <div className="flex items-center gap-3">
                              ...
                              <span className="text-[10px] font-black uppercase tracking-widest text-zinc-900">Compliant</span>
                           </div>
                           <div className="flex items-center gap-3">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                     {[
                        ...
                        <Card key={i} className="p-6 bg-white rounded-3xl border-none shadow-sm flex items-center gap-4">
                           ...
                           <div className="min-w-0">
                              ...
                              <p className="text-[11px] font-bold text-zinc-900 truncate">{meta.value}</p>
                           </div>
                        </Card>
                     ))}
                  </div>
                ...
                <div className="h-[600px] border-2 border-dashed border-zinc-200 rounded-[48px] flex flex-col items-center justify-center text-center p-12 space-y-6">
