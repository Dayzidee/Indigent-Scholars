...
export default function SuperAdminSettings() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <header>
        <h1 className="text-3xl font-black text-white mb-2 tracking-tight">Platform Governance</h1>
        <p className="text-slate-500 font-medium flex items-center">
          <span className="material-symbols-outlined text-[18px] mr-2 text-amber-400">shield</span>
        ...
        <div className="p-8 rounded-3xl bg-slate-900/40 border border-slate-800 space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <input type="text" defaultValue="2,500,000" className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-white font-medium focus:border-amber-500/50 outline-none" />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-bold text-slate-500 uppercase tracking-widest px-1">Institutional Platform Fee (%)</label>
              <input type="text" defaultValue="0.0" className="w-full px-4 py-3 bg-slate-950 border border-slate-800 rounded-xl text-white font-medium focus:border-amber-500/50 outline-none" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between hover:border-slate-700 transition-all">
            <div className="flex items-center space-x-3">
              <span className="material-symbols-outlined text-[18px] text-slate-500">dns</span>
              <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Paystack API</span>
            </div>
          ...
          <div className="p-4 rounded-xl bg-slate-950 border border-slate-800 flex items-center justify-between hover:border-slate-700 transition-all">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xs font-bold text-slate-400 uppercase tracking-widest">Email Gateway</span>
            </div>
      ...
      <div className="flex justify-between items-center pt-4 pb-12">
        ...
        <button onClick={handleSave} className="flex items-center space-x-3 px-8 py-4 bg-amber-600 hover:bg-amber-500 text-white font-bold rounded-2xl transition-all shadow-xl shadow-amber-500/20 active:scale-95">
