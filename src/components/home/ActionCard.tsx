...
export function ActionCard({ title, description, href, buttonText, variant = 'primary' }: ActionCardProps) {
  return (
    <motion.div
      ...
      className="group relative bg-white/5 backdrop-blur-xl p-7 rounded-[1.5rem] border border-zinc-800/10 shadow-xl shadow-primary/[0.01] flex flex-col gap-5 overflow-hidden max-w-sm"
    >
      {/* Accent Glow */}
      <div className={cn(
