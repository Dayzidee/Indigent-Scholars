          ...
          <Card className="h-full bg-white rounded-[40px] border-none shadow-2xl shadow-zinc-200/50 p-10 relative overflow-hidden flex flex-col">
            <div className="relative z-10 flex flex-col h-full">
              <div className="flex justify-between items-start mb-10">
                ...
                <div className="px-3 py-1 rounded-full bg-amber-50 text-amber-600 text-[8px] font-black uppercase tracking-widest border border-amber-100 animate-pulse">Incomplete</div>
              </div>

              <div className="space-y-4 mb-auto">
                <div className="flex justify-between items-end mb-2">
                   <h3 className="text-xl font-headline font-black text-zinc-900 leading-none">Registration</h3>
                   <span className="text-2xl font-headline font-black text-zinc-900">{completionPercentage}%</span>
                </div>
        ...
        >
          <Card className="h-full bg-zinc-50 rounded-[40px] border-none p-10 flex flex-col relative overflow-hidden">
            <div className="flex items-center justify-between mb-8">
               <h3 className="text-lg font-headline font-black tracking-tight text-zinc-900">Opportunities</h3>
            ...
            <div className="space-y-4 flex-1">
               {quickAdverts.map((ad, i) => (
                 <div key={i} className="p-5 rounded-[24px] bg-white border border-zinc-100 hover:shadow-lg transition-all cursor-pointer group">
                    <p className={cn("text-[8px] font-black uppercase tracking-widest mb-1", ad.portal === 'Internal' ? "text-blue-600" : "text-emerald-600")}>{ad.portal}</p>
                    <h4 className="text-xs font-headline font-black text-zinc-800 leading-tight mb-3 group-hover:text-blue-600 transition-colors">{ad.title}</h4>
