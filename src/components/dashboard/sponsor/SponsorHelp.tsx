    ...
    >
      ...
      <section className="text-center space-y-6 md:space-y-8 pt-6 md:pt-10">
        <div className="space-y-2">
          ...
          <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-zinc-100 tracking-tight font-headline leading-tight">How can we assist you?</h1>
        </div>
      ...
      {/* FAQs */}
      <section className="bg-zinc-800 rounded-3xl lg:rounded-[48px] p-6 sm:p-12 border border-zinc-800">
        <h2 className="text-3xl font-black text-zinc-100 mb-10 font-headline tracking-tight px-4 text-center">Frequently Asked Questions</h2>
      ...
      <section className="bg-[#0052CC] rounded-3xl lg:rounded-[48px] p-8 md:p-16 text-center space-y-8 shadow-xl shadow-blue-950/40 relative overflow-hidden group">
        ...
        <div className="flex flex-wrap justify-center gap-4 relative z-10">
          ...
          <Button variant="outline" size="lg" className="border-zinc-800/20 text-white hover:bg-white/10" iconLeft="mail">Email Support</Button>
        </div>
      </section>
    </motion.div>
  )
